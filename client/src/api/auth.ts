...
export async function updateProfile(data: { displayName?: string; timezone?: string; locale?: string; useGravatar?: boolean; showAllTasksList?: boolean; showPriorityTasksList?: boolean; pinnedProjectIds?: string[]; pinnedTagIds?: string[] }): Promise<UserProfile> {
