...
// This DndContext only serves task-related drags now (task chips → sidebar
// projects / Inbox, task reorder in ProjectTaskList). Sidebar project/folder
// dragging runs on its own pointer-events engine (see layout/sidebarDrag/) and
// never registers dnd-kit draggables.
